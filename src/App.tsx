...
export default function App() {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-slate-800 via-slate-900 to-black p-2 font-sans overscroll-none touch-none overflow-hidden">
